...
public class SearchQueryValidator {
     ...
     * @return
     */
    public static boolean isJustSymbolOrNumbers(String searchQuery) {
     ...
     * @return
     */
    public static boolean isJustCharactersWithNumbers(String searchQuery) {
        if (searchQuery == null || searchQuery.trim().isEmpty()) {
            return false;
        }
    ...
    public static boolean validateString(String input){
        if(!isJustSymbolOrNumbers(input) && isJustCharactersWithNumbers(input)){
